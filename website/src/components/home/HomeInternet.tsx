      ...
      <div className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        <div className="flex h-full flex-col justify-center rounded-2xl border-2 border-dashed border-slate-300 px-4 py-3 transition-all duration-300 hover:border-blue-500 hover:bg-slate-50 dark:border-slate-700 dark:hover:border-blue-400 dark:hover:bg-slate-800/50">
          <div className="pb-1.5 text-lg font-medium">
            <Translate id="homepage.publicE2e.feature.play.title">
              多格式在线预览
            </Translate>
          </div>
          <p className="m-0 text-sm leading-relaxed text-slate-700 dark:text-slate-200">
            <Translate id="homepage.publicE2e.feature.play.text">
              PDF、图片、音频、文本与代码、MP4
              视频等可在浏览器中预览；视频支持边收边看。
            </Translate>
          </p>
        </div>
        <div className="flex h-full flex-col justify-center rounded-2xl border-2 border-dashed border-slate-300 px-4 py-3 transition-all duration-300 hover:border-blue-500 hover:bg-slate-50 dark:border-slate-700 dark:hover:border-blue-400 dark:hover:bg-slate-800/50">
          <div className="pb-1.5 text-lg font-medium">
            <Translate id="homepage.publicE2e.feature.download.title">
              高速下载
            </Translate>
          </div>
          <p className="m-0 text-sm leading-relaxed text-slate-700 dark:text-slate-200">
        ...
        <div className="flex h-full flex-col justify-center rounded-2xl border-2 border-dashed border-slate-300 px-4 py-3 transition-all duration-300 hover:border-blue-500 hover:bg-slate-50 dark:border-slate-700 dark:hover:border-blue-400 dark:hover:bg-slate-800/50">
          <div className="pb-1.5 text-lg font-medium">
            <Translate id="homepage.publicE2e.feature.privacy.title">
              隐私优先
            </Translate>
          </div>
          <p className="m-0 text-sm leading-relaxed text-slate-700 dark:text-slate-200">
        ...
        <div className="flex h-full flex-col justify-center rounded-2xl border-2 border-dashed border-slate-300 px-4 py-3 transition-all duration-300 hover:border-blue-500 hover:bg-slate-50 dark:border-slate-700 dark:hover:border-blue-400 dark:hover:bg-slate-800/50">
          <div className="pb-1.5 text-lg font-medium">
            <Translate id="homepage.publicE2e.feature.efficiency.title">
              效率提升
            </Translate>
          </div>
          <p className="m-0 text-sm leading-relaxed text-slate-700 dark:text-slate-200">
        ...
        <div className="flex h-full flex-col justify-center rounded-2xl border-2 border-dashed border-slate-300 px-4 py-3 transition-all duration-300 hover:border-blue-500 hover:bg-slate-50 dark:border-slate-700 dark:hover:border-blue-400 dark:hover:bg-slate-800/50">
          <div className="pb-1.5 text-lg font-medium">
            <Translate id="homepage.publicE2e.feature.easy.title">
              操作简单
            </Translate>
          </div>
          <p className="m-0 text-sm leading-relaxed text-slate-700 dark:text-slate-200">
        ...
        <div className="flex h-full flex-col justify-center rounded-2xl border-2 border-dashed border-slate-300 px-4 py-3 transition-all duration-300 hover:border-blue-500 hover:bg-slate-50 dark:border-slate-700 dark:hover:border-blue-400 dark:hover:bg-slate-800/50">
          <div className="pb-1.5 text-lg font-medium">
            <Translate id="homepage.publicE2e.feature.lan.title">
              局域网传输
            </Translate>
          </div>
          <p className="m-0 text-sm leading-relaxed text-slate-700 dark:text-slate-200">
